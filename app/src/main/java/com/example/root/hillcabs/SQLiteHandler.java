...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "DB_HC_Prod";
   ...
   // private static final String KEY_createdAt = "createdAt";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_USER + "("
                + KEY_uid + " INTEGER PRIMARY KEY," + KEY_firstName + " TEXT,"
                + KEY_email + " TEXT,"
                + KEY_lastName + " TEXT," + KEY_phone + " TEXT)";
     ...
     * */
    public void addUser(String firstName, String lastName, String email,String phone, String uid) {
        ...
        //values.put(KEY_createdAt, created_at); // Created At
